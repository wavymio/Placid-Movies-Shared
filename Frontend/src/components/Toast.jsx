...
const Toast = ({ type, message, onClose }) => {
  ...
  return (
    <div onClick={onClose} className={`opacity-100 z-50 m-0 backdrop-filter backdrop-blur-lg border-none sm:border-l-2 sm:border-b-0 relative sm:min-w-52 w-full flex justify-left items-center gap-3 p-6 text-md rounded-b-lg sm:rounded-lg shadow-lg text-white ${getBackgroundColor(type)} animate-fade-in-out`}>
