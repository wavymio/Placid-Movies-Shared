    ...
    return (
        <defs>
            <linearGradient id="oceaniaGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="5%" stopColor="#A9A9A9" />  {/* Deep Blue */}
                <stop offset="10%" stopColor="#0077BE" />  {/* Deep Blue */}
                <stop offset="40%" stopColor="#1E90FF" />  {/* Light Blue */}
                {/* <stop offset="70%" stopColor="#006400" /> */}
                <stop offset="80%" stopColor="#2E8B57" />  
                <stop offset="95%" stopColor="#CDAA6D" />  {/* Sand */}
            </linearGradient>
